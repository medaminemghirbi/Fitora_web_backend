...
RSpec.describe "Api::V1::Notifications", type: :request do
  ...
  describe "GET /api/v1/notifications" do
    ...
    it "also serves a Fitora admin's own notifications (e.g. system_update)" do
      admin = create(:user, :admin)
      create(:notification, company: nil, recipient: admin, kind: "system_update", dedup_key: "system_update-1")
